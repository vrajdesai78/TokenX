            ...
            <div className="flex justify-center flex-row">
              <div className="flex flex-col justify-between text-center h-[100vh] py-10 md:py-32">
                <Image
                  ...
                  alt="TokenX"
                />
                <h1 className="text-4xl sm:text-5xl font-extrabold text-[#E4E4ED] animate__animated animate__zoomIn">
                  TokenX
                </h1>
                <div className="text-4xl tracking-tight font-extrabold text-[#E4E4ED] mt-[5rem] sm:text-5xl md:text-7xl lg:px-32 space-y-5">
